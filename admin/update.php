...
$sql="UPDATE `users` SET `f_name`='$fname',`l_name`='$lname',`email`='$email',`phone_no`='$phone_no',`gender`='$gender' where id='$id'";
                                    ...
                                    <div class="card-header">
                                        <div class="card-body">
                                            ...
                                            First Name:<input type="text" name="fname"
                                                value=<?php echo $user['f_name']?>><br><br>

                                            Last Name:<input type="text" name="lname"
                                                value=<?php echo $user['l_name']?>><br><br>
