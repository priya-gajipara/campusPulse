        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="form.php" method="POST">
                    ...
                    Email-Id: <br><input type="email" placholder="name@gmail.com" name="email"><br><br>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="role_id" id="teacher" value="2">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="role_id" id="admin" value="3">
